...
<input type="hidden" name="id" value ="<?php echo $id; ?>">
    <ul>
        <li>
            ...
            <input type="text"  placeholder="eks: 02.07.88" required  name="dato" value="<?php echo $row['dato']; ?>"/>
	    <span class="form_hint">Riktig format: "02.09.22"</span>
        </li>
        <li>
	 ...
	 <li>
        ...
        <li>
         ...
         <label for="name">Tyveringsmerke:</label>
            <input type="text"  placeholder="" required  name="tyveringsmerke" value="<?php echo $row['tyveringsmerke']; ?>"/>
	    <span class="form_hint">Proper format ""</span>
        </li>
        <li>
        
         <label for="name">Utlevert:</label>
            <input type="text"  placeholder="eks Høsten 2015" required  name="delivered" value="<?php echo $row['delivered']; ?>"/>
	    <span class="form_hint">Proper format "Eks høsten 2015"</span>
        </li>
        <li>
		
		 <label for="name">Levert tilbake:</label>
            <input type="text"  placeholder="eks Høsten 2015" required  name="deliveredback" value="<?php echo $row['deliveredback']; ?>"/>
	    <span class="form_hint">Proper format "Eks høsten 2015"</span>
        </li>
        <li>
